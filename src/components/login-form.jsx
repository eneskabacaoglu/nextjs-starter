  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <form onSubmit={handleEmailLogin}>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <h1 className="text-xl font-bold">Welcome to Blend</h1>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="text-center mt-1">
              <a href="/forgot-password" className="underline underline-offset-4 text-sm text-muted-foreground hover:text-primary">Forgot your password?</a>
            </div>
          </div>
      ...
      <div
        ...
        By clicking continue, you agree to our <a href="/terms">Terms of Use</a>{" "}
